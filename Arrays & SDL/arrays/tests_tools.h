 ...
 */
static inline void array_random_fill(int array[], size_t len, int maxval)
{
 ...
 */
static inline void array_sorted_fill(int array[], size_t len, int step)
{
    int cur = 0;
 ...
 * step is the difference between values
 */
static inline void array_reverse_sorted_fill(int array[], size_t len, int step)
{
    int cur = (len - 1) * step;
    for (size_t i = 0; i < len; ++i, cur -= step)
        array[i] = cur;
 ...
 */
static inline int int_len(int x)
{
    int len = 0;
    for (; x > 0; x /= 10)
        len += 1;
 ...
 */
static inline void array_print(int array[], size_t len, int maxval)
{
    int line = 0;
