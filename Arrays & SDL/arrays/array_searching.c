...
static inline void search_help(search_fun fun, int array[], size_t len, int x)
{
...
static void test_search(int array[], size_t len)
{
    int x;
...
static void test_bin_search(int array[], size_t len)
{
    int x;
